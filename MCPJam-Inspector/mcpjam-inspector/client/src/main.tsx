...
if (isInIframe) {
  ...
  if (!workosClientId && !internalAuthEnabled) {
    console.warn(
  ...
  const Providers = internalAuthEnabled ? (
    <InternalAuthProvider>
      <ConvexProviderWithAuthKit client={convex} useAuth={useInternalAuth}>
        <App />
