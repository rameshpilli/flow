"""Contracts for the Gastown MVP Polecat flow."""
...
@dataclass
class ResearchBrief:
    """Lightweight deep-research output for downstream agents."""
...
@dataclass
class QAOutput:
    """Output from the QA supervisor stack."""
...
@dataclass
class DocsOutput:
    """Output from the documentation supervisor stack."""
...
class ExecutionEvidence:
    """Captured execution/test evidence from the repo worktree."""
