"""
Client Meeting Prep Tool (CMPT) Chain Implementation using AgentOrchestrator

This module implements the full CMPT pipeline using AgentOrchestrator's DAG-based
...
async def run_cmpt_chain(
    ...
    # AgentOrchestrator will validate again at launch time for fail-fast behavior
    result = await forge.launch("cmpt_pipeline", data={"request": request})
    return result
