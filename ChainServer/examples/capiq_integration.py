...
1. Create a custom Capital IQ agent
2. Define steps that fetch different data types
3. Chain CapIQ data with other sources (SEC, News)
4. Build an enhanced financial analysis pipeline

This is a template for integrating any financial data API with FlowForge.
"""
...
from flowforge.middleware import LoggerMiddleware
...
# ============================================================
# 1. CREATE THE FLOWFORGE INSTANCE
# ============================================================
...
@forge.agent(name="sec_filing", version="1.0")
...
@forge.agent(name="news", version="1.0")
...
@forge.step(name="extract_context", produces=["company_name", "ticker"])
...
async def fetch_sec_filings(ctx: ChainContext):
    ...
    agent = forge.get_agent("sec_filing")
...
"""
    ...
    report += "\n---\n*Generated by FlowForge with Capital IQ data*\n"
...
async def main():
    print("\n" + "=" * 70)
    print("  FlowForge: Capital IQ Integration Demo")
    print("=" * 70 + "\n")
    ...
    # Visualize the chain
    print("Chain DAG:")
    print(forge.visualize_chain("capiq_analysis"))
    print()
