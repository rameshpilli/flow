"""
FlowForge Health Check Aggregator
...
Usage:
    from flowforge.utils.health import HealthAggregator, run_health_checks
...
CLI:
    ...
    flowforge health --detailed   # Full dependency checks
    flowforge health --json       # JSON output
"""
...
async def check_redis_health() -> ComponentHealth:
    ...
    try:
        from flowforge.core.context_store import get_context_store
