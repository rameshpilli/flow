...
class FlowForgeConfig:
    """
    FlowForge configuration with typed fields and validation.
    ...
    def from_env(cls) -> "FlowForgeConfig":
        ...
        fields = [
            # Service
            ConfigField("FLOWFORGE_SERVICE_NAME", default="flowforge"),
        ...
        return cls(
            service_name=values.get("FLOWFORGE_SERVICE_NAME", "flowforge"),
...
_config: FlowForgeConfig | None = None


def get_config() -> FlowForgeConfig:
    """
    ...
    global _config
    if _config is None:
        _config = FlowForgeConfig.from_env()
    return _config


def set_config(config: FlowForgeConfig) -> None:
