...
def configure_logging(
    ...
    Usage:
        from flowforge.utils.logging import configure_logging
...
class ChainLogger:
    ...
    def __init__(self, chain_name: str, request_id: str | None = None):
        ...
        self._logger = get_logger(f"flowforge.chain.{chain_name}")
