"""
FlowForge Configuration Module

Centralized configuration management using environment variables.
All settings are loaded once and distributed downstream.

Usage:
    from flowforge.config import get_config, Config
...
class Config:
    ...
    def get_summarizer(self) -> Any:
        ...
        """
        from flowforge.middleware.summarizer import LangChainSummarizer, SummarizationStrategy
...
def get_config() -> Config:
    ...
    Usage:
        from flowforge.config import get_config
    ...
    if _config is None:
        ...
        logger.info("FlowForge configuration loaded from environment")
    return _config
...
def reload_config() -> Config:
    ...
    global _config
    _config = Config.from_env()
    logger.info("FlowForge configuration reloaded")
    return _config
...
def set_config(config: Config) -> None:
    ...
    Usage:
        from flowforge.config import Config, set_config
    ...
    global _config
    _config = config
    logger.info("Custom FlowForge configuration set")
