...
from flowforge.core.registry import get_chain_registry, get_step_registry
...
class DAGVisualizer:
    """
    Generates ASCII and Mermaid visualizations of FlowForge chains.
