"""
Unit Tests for FlowForge Middleware Module
...
class TestMiddlewareIntegration:
    """Tests for middleware integration with FlowForge."""

    @pytest.fixture
    def forge(self):
        """Create an isolated forge for testing."""
        return FlowForge.temp_registries("middleware_test")
...
class TestMiddlewareErrorHandling:
    ...
    async def test_on_error_called_on_step_failure(self):
        ...
        forge = FlowForge.temp_registries("error_test")
        forge.use(tracker)
    ...
    async def test_after_called_even_on_failure(self):
        ...
        forge = FlowForge.temp_registries("after_error_test")
...
class TestMultipleMiddleware:
    ...
    async def test_chained_context_modifications(self):
        ...
        forge = FlowForge.temp_registries("chained_mw")
    ...
    async def test_middleware_can_short_circuit(self):
        ...
        forge = FlowForge.temp_registries("cache_test")
