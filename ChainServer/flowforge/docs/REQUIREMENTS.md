# FlowForge - Project Requirements

## Overview

FlowForge is a DAG-based chain orchestration framework for building AI/ML pipelines. It provides decorator-driven registration, automatic dependency resolution, and production-grade resilience features.
...
#### Summarization (`pip install flowforge[summarization]`)
| Package | Version | Purpose |
|---------|---------|---------|
...
#### OpenAI Support (`pip install flowforge[openai]`)
| Package | Version | Purpose |
|---------|---------|---------|
| `langchain-openai` | >=0.0.5 | OpenAI LLM client |

#### Anthropic Support (`pip install flowforge[anthropic]`)
| Package | Version | Purpose |
|---------|---------|---------|
| `langchain-anthropic` | >=0.1.0 | Claude LLM client |

#### Observability (`pip install flowforge[observability]`)
| Package | Version | Purpose |
|---------|---------|---------|
...
#### Full Installation (`pip install flowforge[all]`)
...
```python
from flowforge import FlowForge, create_openai_summarizer, SummarizerMiddleware
...
**Requirements**: `pip install flowforge[openai]`
...
```bash
# Run all tests
pytest flowforge/tests/ -v

# Run with coverage
pytest flowforge/tests/ --cov=flowforge --cov-report=html

# Run specific test categories
pytest flowforge/tests/unit/ -v
pytest flowforge/tests/integration/ -v
```
...
| FlowForge | Python | Pydantic | LangChain |
|-----------|--------|----------|-----------|
...
- **GitHub Issues**: [github.com/your-org/flowforge/issues](https://github.com/your-org/flowforge/issues)
- **Documentation**: [flowforge.readthedocs.io](https://flowforge.readthedocs.io)
