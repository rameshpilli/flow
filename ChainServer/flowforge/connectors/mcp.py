"""
FlowForge MCP Connector

Provides integration with MCP (Model Context Protocol) servers.
Allows users to register their own MCP servers as FlowForge agents.
"""
...
from flowforge.core.decorators import agent
...
class MCPConnector(BaseConnector):
    ...
    Allows FlowForge to communicate with external MCP servers,
