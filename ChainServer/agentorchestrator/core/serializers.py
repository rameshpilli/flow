"""
AgentOrchestrator Context Serializers
...
Usage:
    from agentorchestrator.core.serializers import TruncatingSerializer, RedactingSerializer
...
class TruncatingSerializer(ContextSerializer):
    ...
    def serialize_value(self, key: str, value: Any) -> Any:
        ...
        if self.preserve_context_refs:
            from agentorchestrator.core.context_store import ContextRef, is_context_ref
...
class ContextRefSerializer(ContextSerializer):
    ...
    def serialize_value(self, key: str, value: Any) -> Any:
        ...
        from agentorchestrator.core.context_store import ContextRef
