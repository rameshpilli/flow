...
Discovers and loads AgentOrchestrator plugins via Python entry points.
...
AGENT_ENTRY_POINT = "agentorchestrator.agents"
CONNECTOR_ENTRY_POINT = "agentorchestrator.connectors"
MIDDLEWARE_ENTRY_POINT = "agentorchestrator.middleware"
...
class PluginInfo:
    ...
    Attributes:
        ...
        group: Entry point group (e.g., "agentorchestrator.agents")
...
def discover_plugins(
    ...
    """
    Discover all AgentOrchestrator plugins via entry points.

    Args:
        groups: Entry point groups to scan (default: all AgentOrchestrator groups)
