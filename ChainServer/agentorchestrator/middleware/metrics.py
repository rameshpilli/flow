"""
AgentOrchestrator Metrics Middleware
    ...
    def _get_histogram(self, name: str) -> Any:
        ...
        if name not in self._histograms:
            self._histograms[name] = self._meter.create_histogram(
                ...
                description=f"AgentOrchestrator {name}",
            )
...
class MetricsMiddleware(Middleware):
    ...
    # Metric names
    STEP_DURATION = "agentorchestrator.step.duration_ms"
    STEP_EXECUTIONS = "agentorchestrator.step.executions_total"
    STEP_ERRORS = "agentorchestrator.step.errors_total"
    STEP_RETRIES = "agentorchestrator.step.retries_total"
    STEPS_IN_PROGRESS = "agentorchestrator.step.in_progress"
